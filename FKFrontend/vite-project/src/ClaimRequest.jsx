          ...
          >
              ...
              <div className="w-full lg:w-1/2 border border-blue-200 p-4 rounded bg-white dark:bg-gray-800">
                ...
                {claim.image ? (
                  ...
                  <div className="w-96 h-52 mt-9 ml-12 mb-4 flex justify-center bg-gray-200 dark:bg-gray-600 rounded-xl">
                    <p className="text-gray-500 text-md my-auto italic">
                ...
                <p className="text-sm text-gray-500">
                  Posted on: {new Date(claim.timestamp).toLocaleString()}
                </p>
              </div>
            ...
            {isAdmin && (
              <div className="mt-6 flex justify-center gap-6">
                <button className="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">Accept</button>
                <button className="px-6 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600">Reject</button>
              </div>
            )}
          </div>
        ))
